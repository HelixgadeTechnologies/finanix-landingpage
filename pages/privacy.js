      ...
      <div className="w-full flex flex-col xl:flex-row">
        ...
        <div className="w-full">
          ...
          <div className="w-full bg-backgroundgray p-6 md:min-h-screen">
            ...
            At Finanix, we recognize the significance of privacy and are committed
            to protecting the confidentiality of your personal
            information. Our Privacy Policy
            ...
            <ol className="space-y-6 px-6 pb-6 list-decimal text-slate-700">
              <li>
              Information Collection: We collect only the necessary personal information to provide you with our services and comply with legal requirements. This includes identification data, contact details, and transaction history.
            ...
            to safeguard your data from unauthorized access, alteration, or disclosure.
              </li>
              <li>
                {' '}
            Information Sharing: Your personal information is never sold,
            rented, or shared with third parties for marketing purposes.
            We may share data with trusted partners for specific purposes,
            such as regulatory compliance.
              ...
              <li>
                ...
                gather analytical insights. You can manage your cookie preferences
                in your browser settings.
              </li>
              <li>
                Communication Preferences: You can control how we communicate with
                you regarding promotions, updates, and news
                by adjusting your preferences in your account settings.
            </li>
            </ol>
                      
            <p className='text-slate-700'>
            Please review our complete Privacy Policy for a comprehensive understanding of how we handle your data.
            </p>
          </div>
          <div>
            <Footer />
