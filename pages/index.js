  ...
  return (
    ...
    <div className='bg-white'>
      ...
      <section className='bg-blueGray w-full mt-36 pb-24 p-3 md:mt-72 md:pt-24'>
        <h1 className='font-bold text-4xl text-center mb-6'>Our Top Partners</h1>
        <div className='flex flex-row justify-around flex-wrap gap-3 mt-3 md:mt-12'>
          ...
          <Image src={bitcoin97} alt='bitcoin mini logo'  className="w-24 md:w-28 h-6" />
          <Image src={tether98} alt='tether98'  className="w-28 h-8" />
          <Image src={bitmexlogo} alt='bitmex logo'  className="w-24 h-4 mt-2 md:w-28 md:mt-0" />
        </div>
      ...
      <section className='w-full'>
        <h1 className='text-4xl max-w-sm font-bold text-center mx-auto pt-6 md:py-24'>Get Started in Just A Few Minutes</h1>
        <div className='py-32 w-full p-3 relative md:bg-lightGray'>
          ...
          <div className='flex flex-col gap-12 md:flex-row md:justify-center md:absolute md:-top-20 md:inset-x-0'>
            ...
            <Image src={creataccount} alt='account creation' className='w-full md:w-72 md:h-72' />
            <Image src={addfunds} alt='add funds to your account' className='w-full md:w-72 md:h-72' />
            <Image src={planchoice} alt='choose a plan' className='w-full md:w-72 md:h-72' />
          </div>
        </div>
        ...
        <div className='flex flex-col justify-center flex-wrap items-center px-3 pb-12 gap-3 md:flex-row md:p-12'>
          ...
          <div className='flex flex-col gap-3'>
            ...
            <p className='text-darkBlueBlack max-w-lg leading-7 text-lg'>
              ...
              trading and investment management. Powered by advanced AI algorithms
              and a team of financial experts, we offer a secure and efficient
              platform for you to navigate the world of Bitcoin with ease.
            </p>
      ...
      <section className='bg-blueGray p-4 md:p-12'>
        ...
        <div className='flex flex-row flex-wrap w-full gap-6 justify-center'>
          ...
          <div className='py-8 px-4 shadow-xl border border-slate-300 rounded-lg flex flex-col gap-3 w-full md:w-fit'>
            <h2 className='text-center text-xl font-bold mb-2 bg-gray-200 w-fit mx-auto px-2'>WEEKLY</h2>
            <span className='flex flex-row gap-2 text-md'>
              <Image src={tickcircle} alt='tick box' />
             <p> 5% ROI daily</p>
            </span>
          ...
          <div className='py-8 px-4 shadow-xl border border-slate-300 rounded-lg flex flex-col gap-3 w-full md:w-fit'>
            <h2 className='text-center text-xl font-bold mb-2 bg-gray-200 w-fit mx-auto px-2'>MONTHLY</h2>
            <span className='flex flex-row gap-2 text-md'>
              <Image src={tickcircle} alt='tick box' />
             <p> 10% ROI daily</p>
            </span>
          ...
          <div className='py-8 px-4 shadow-xl border border-slate-300 rounded-lg flex flex-col gap-3 w-full md:w-fit'>
            <h2 className='text-center text-xl font-bold mb-2 bg-gray-200 w-fit mx-auto px-2'>YEARLY</h2>
            <span className='flex flex-row gap-2 text-md'>
              <Image src={tickcircle} alt='tick box' />
             <p> 15% ROI daily</p>
            </span>
      ...
      <section className='py-12'>
        <h1 className='py-12 text-3xl w-full text-center mx-auto font-bold md:text-5xl md:w-3/4 md:text-left'>What Everyone Says...</h1>
        <div className="flex flex-col sm:flex-row sm:justify-center sm:flex-wrap md:flex-nowrap md:w-3/4 mx-auto md:overflow-x-auto ...">
          <Image src={testimonialOne} alt='testimonials' className='w-full sm:w-72  h-1/4'/>
          <Image src={testimonialTwo} alt='testimonials' className='w-full sm:w-72  h-1/4'/>
          <Image src={TestimonialThree} alt='testimonials' className='w-full sm:w-72  h-1/4'/>
          <Image src={testimonialTwo} alt='testimonials' className='w-full sm:w-72  h-1/4'/>
          <Image src={testimonialOne} alt='testimonials' className='w-full sm:hidden sm:w-72 md:block md:w-72 h-1/4'/>
          {/* <Image src={testimonialOne} alt='testimonials'/> */}
        </div>
        
        <div className='p-3'>
          <h1 className='text-2xl text-center py-6 font-bold md:text-6xl'>Frequently Asked Questions</h1>
          <h3 className='text-center text-xl'>Have Questions? We Have Answers!</h3>

          <div className='max-w-3xl mx-auto mt-24'>
            <div className='hidden md:flex md:flex-row md:justify-between md:items-center'>
              <h2 className='text-2xl font-bold'>Are my investments safe with Finanix?</h2>
              <Image src={minusicon} alt='minus sign'/>
            </div>
            <p className='hidden md:block'>
              Absolutely! Your security is our top priority.
              Our platform utilizes top-notch encryption and
              security protocols to ensure the safety of your
              funds and personal data.
            </p>

            <div className='flex flex-row mt-12 justify-between items-center'>
              <h2 className='text-2xl font-bold max-w-sm md:max-w-prose'>How do i get started?</h2>
              <Image src={plusicon} alt='minus sign' className='w-12 h-12'/>
            </div>
            
            <div className='flex flex-row mt-12 justify-between items-center'>
              <h2 className='text-2xl font-bold max-w-sm md:max-w-prose'>How does AI support work?</h2>
              <Image src={plusicon} alt='minus sign' className='w-12 h-12'/>
            </div>

            <div className='flex flex-row mt-12 justify-between items-center'>
              <h2 className='text-2xl font-bold max-w-sm md:max-w-prose'>Can i use Finanix from anywhere in the world?</h2>
              <Image src={plusicon} alt='minus sign' className='w-12 h-12'/>
            </div>

            <div className='flex flex-row mt-12 justify-between items-center'>
              <h2 className='text-2xl font-bold max-w-sm md:max-w-prose'>What is Arbitrage trading?</h2>
              <Image src={plusicon} alt='minus sign' className='w-12 h-12'/>
            </div>
          </div>
        </div>
