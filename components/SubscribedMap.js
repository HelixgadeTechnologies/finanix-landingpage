...
const SubscribedMap = () => {
    ...
    return (
        <div className='bg-white text-black min-h-screen p-6'>
            ...
            return (
            <div className="py-8 px-3 relative shadow-xl border border-slate-300 rounded-lg flex flex-col gap-3 w-full md:w-fit" key={sub.id}>

                    {(sub.duration === 'weekly') ? (
                        <div className=''>
                        <span className='bg-spansubscriptioncolor px-3 w-fit absolute top-2 inset-x-0 translate-x-50 mx-auto text-sm'>Most Popular</span>
            ...
            return (
                <div className='flex flex-row gap-3' key={index}>
                    {(sub.duration === 'daily' || sub.duration === 'weekly') && (index === 5 || index === 6) ? (
