...
const Sidenav = () => {
    ...
    const [isOpen, setIsOpen] = useState(false)
      ...
      return(
          ...
          <>
            {!isOpen ?
            (<button><Image src={menunavbar} alt="menu icon" onClick={()=> setIsOpen(!isOpen)} /></button>):
            (
           ...
           <div>
              ...
              <div className={`w-2/3 fixed top-0 right-0 bg-white h-screen z-[1000] flex flex-col
              ${isOpen? 'translate-x-0': 'translate-x-full'} ease-in-out duration-300`}>
              <button className='bg-white text-black absolute top-6 right-0' onClick={()=> setIsOpen(!isOpen)}>
              ...
              <div className="md:w-full bg-white pt-8 px-3 border-r border-r-solid border-r-slate-400 flex flex-col gap-4">
                    ...
                    <Link href="/">
                        ...
                        <span className="bg-green-400 px-2 py-1 text-[10px] text-white">weekly</span>
                        </div>
                    </Link>
